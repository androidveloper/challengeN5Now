...
WORKDIR /src
COPY ["N5NowWebApi.csproj", "."]
RUN dotnet restore "./N5NowWebApi.csproj"
COPY . .
WORKDIR "/src/."
RUN dotnet build "./N5NowWebApi.csproj" -c %BUILD_CONFIGURATION% -o /app/build

# Esta fase se usa para publicar el proyecto de servicio que se copiará en la fase final.
FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./N5NowWebApi.csproj" -c %BUILD_CONFIGURATION% -o /app/publish /p:UseAppHost=false
